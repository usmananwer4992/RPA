...
import style from './TitleDocumentsExecuted.module.css';
import addImage from '../../assets/images/add.svg';
const TitleDocumentsExecutedComponent =() =>{
	return (
					...
					<div className={`${style.file_upload_wrapper}`}>
						<div className={`${style.upload_lender_pkg} position-relative`}>
							<div className={`${style.upload_lender_box}`}>
								<img src="/upload-icon.svg" className='me-2' alt="" />
...
export default TitleDocumentsExecutedComponent;